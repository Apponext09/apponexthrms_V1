...
export const employeeCreateSchema = z.object({
  ...
  reporting_manager_id: safeInt,
  costCenterId: safeInt,
  avatarUrl: z.string().nullable().optional(),
  bio: z.string().nullable().optional(),
  accessRole: z.enum(['employee', 'team_lead', 'hr_manager', 'department_head', 'cto', 'cfo', 'coo', 'cxo', 'organization_admin', 'intern', 'consultant', 'admin', 'ceo', 'hr_admin', 'hr', 'support', 'super_admin', 'finance']).default('employee'),
