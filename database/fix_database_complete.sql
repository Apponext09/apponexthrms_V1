-- APPONEXT HRMS - COMPLETE DATABASE FIX
-- All missing tables created in dependency order
-- All foreign keys configured correctly
-- EXECUTE THIS SCRIPT ONCE TO COMPLETE DATABASE

-- ============================================================
-- PERFORMANCE MODULE - 6 TABLES
-- ============================================================
