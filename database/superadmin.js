...
(async () => {
  try {
    ...
    // Real argon2id hash for 'SuperAdmin@2026!Secure'
    const passwordHash = '$argon2id$v=19$m=12288,t=3,p=1$oilziN+yf33E222Qu/gyWw$x2mFvKmzdDti+wUdlgBL/KR8E3gkOW7/3abeUqJJY0Q';
