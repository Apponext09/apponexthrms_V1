...
const NAVIGATION_SECTIONS: NavSection[] = [
  ...
  // ── 15. Masters ───────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: 'Location', href: '/masters/location', icon: 'MapPin' },
      { name: 'Department', href: '/masters/department', icon: 'Layers' },
      { name: 'Designation', href: '/masters/designation', icon: 'Briefcase' },
      { name: 'General Shift', href: '/masters/general-shift', icon: 'Clock' },
      { name: 'Roster Shift', href: '/masters/roster-shift', icon: 'Clock' },
      { name: 'OT Rule', href: '/masters/ot-rule', icon: 'Sliders' },
      { name: 'Grade', href: '/masters/grade', icon: 'Award' },
      { name: 'Holiday', href: '/masters/holiday', icon: 'Calendar' },
      { name: 'Employee Status', href: '/masters/employee-status', icon: 'Users' },
      { name: 'Emp. Type', href: '/masters/emp-type', icon: 'Users' },
      { name: 'Events', href: '/masters/events', icon: 'CalendarDays' },
      { name: 'Offer Letter Master', href: '/masters/offer-templates', icon: 'FileText' },
      { name: 'Notification Templates', href: '/masters/notification-templates', icon: 'Bell' },
      { name: 'Notification Merge Codes', href: '/masters/notification-merge-codes', icon: 'Code2' },
      { name: 'Break', href: '/masters/break', icon: 'Coffee' },
      { name: 'Roles & Responsibility', href: '/masters/roles-responsibility', icon: 'ShieldCheck' },
      { name: 'KRA Form', href: '/masters/kra', icon: 'FileText' },
      { name: 'Resource Plan', href: '/masters/resource-plan', icon: 'Grid' },
    ],
  },
  ...
  // ── 16. Module Management ─────────────────────────────────────────────────
  {
    ...
    collapsible: true,
    items: [
      { name: 'CEO / Admin', href: '/modules/ceo', icon: 'ShieldCheck' },
      { name: 'HR', href: '/modules/hr', icon: 'Users' },
      { name: 'Manager', href: '/modules/manager', icon: 'UserCheck' },
      { name: 'Team Lead', href: '/modules/team-lead', icon: 'UserCog' },
      { name: 'Employee', href: '/modules/employee', icon: 'User' },
      { name: 'Intern', href: '/modules/intern', icon: 'GraduationCap', badge: 'Coming Soon' },
    ],
  },
