        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-sm">
          <CardHeader className="p-3 px-4 border-b border-slate-100 dark:border-slate-800 flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-xs font-bold">Payroll Cycle</CardTitle>
            </div>
          ...
          <CardContent className="p-2 space-y-1.5">
            ...
            >
              <Plus className="w-3.5 h-3.5" /> Add New Payroll Cycle
            </Button>
          </CardContent>
        </Card>
      </div>
            ...
            <CardTitle className="text-xs font-bold flex items-center gap-1.5">
              {selectedCycleId ? (
                <>
                  ...
                  Edit Payroll Cycle ({cycleForm.name || 'Selected'})
                </>
              ) : (
                <>
                  <Plus className="w-3.5 h-3.5 text-indigo-500" />
                  Add New Payroll Cycle
                </>
              )}
            </CardTitle>
          </CardHeader>
                ...
                <div className="md:col-span-8">
                  <Input
                    ...
                    onChange={e => {
                      ...
                      if (selectedCycleId) {
                        setCycles(prev => prev.map(c => c.id === selectedCycleId ? { ...c, name: val } : c));
                      }
                    }}
