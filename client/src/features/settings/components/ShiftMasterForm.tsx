...
export function ShiftMasterForm({ onCancel, onSave }: ShiftMasterFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast.success('Shift Created', `${finalShiftName} created successfully.`);
      await getAllShifts();
      resetForm();
    } catch (err: any) {
  ...
  // Excluded days list for Working Pattern Table
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {/* ========================================================================= */}
        {/* LEFT COLUMN: Full + Add Shift Form                                         */}
        {/* ========================================================================= */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-xs font-semibold">
            ...
            <div className="bg-card border border-border/80 rounded-2xl p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-border pb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="font-bold text-sm text-foreground tracking-tight">Add Shift Information</h3>
              ...
              {/* Shift Name, Shift Type, Flexible Mode */}
              ...
              <div className="space-y-1.5 pt-1 border-t border-border/50">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div
                    className="w-7 h-7 rounded-lg border border-border flex items-center justify-center text-[10px] font-mono text-muted-foreground"
            ...
            {!isFlexible && (
              <div className="bg-card border border-border/80 rounded-2xl p-5 shadow-xs space-y-4">
                ...
                {/* Row 1: Start, End, Buffer, Half Day After */}
                ...
                {/* Row 2: Total Time, Log Break Time, Actual Working Hours */}
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-3.5 items-center pt-1 border-t border-border/50">
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              isSel ? 'bg-emerald-600 text-white border-emerald-600' : 'bg-muted/40 border-border text-muted-foreground hover:text-foreground'
                            )}
                          >
                            {preset}
                          </button>
                  ...
                  {/* Calculated Actual Working Hours Box */}
                  <div className="sm:col-span-4 border border-emerald-500/30 bg-emerald-500/10 rounded-xl p-2.5 flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-xs text-emerald-600/80 dark:text-emerald-400/80 text-[10px]">Total Time - Log Break Time</span>
                    </div>
                    <div className="text-right">
                      <span className="font-mono font-bold text-sm text-emerald-700 dark:text-emerald-300">{actualHours} hrs</span>
                      <span className="block text-[9px] text-emerald-600/70 dark:text-emerald-400/70">Calculated (HH:MM)</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isIncluded
                          ...
                          : 'border-border bg-muted/20 text-muted-foreground hover:bg-muted/40 font-medium'
                      )}
                    >
                            ...
                            {(['first', 'second', 'third', 'fourth', 'fifth', 'last', 'halfDay'] as (keyof ExcludedDayPattern)[]).map((col) => (
                              <td key={col} className="py-2 px-1 text-center">
                                <input
                                  ...
                                  className="h-3.5 w-3.5 rounded text-emerald-600 focus:ring-emerald-500 border-input cursor-pointer"
                                />
                              </td>
                            ))}
            ...
            {/* BOTTOM BAR: Active Status & Action Buttons */}
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {submitting ? (
                    ...
                    <><Plus className="h-4 w-4 stroke-[2.5]" /> Add Shift</>
                  )}
                </button>
              </div>
            </div>
        ...
        {/* ========================================================================= */}
        {/* RIGHT COLUMN: Shifts Display & Search Panel                                */}
        {/* ========================================================================= */}
            ...
            <div className="space-y-3 max-h-[700px] overflow-y-auto pr-0.5">
              ...
              {!loading && filteredShifts.length === 0 && (
                <div className="text-center py-10 border border-dashed border-border rounded-xl text-muted-foreground text-xs space-y-1.5 bg-muted/20">
                  ...
                  <p className="font-semibold text-foreground">No shifts found</p>
                  <p className="text-[11px] text-muted-foreground">Add a shift using the form on the left.</p>
                </div>
              )}
            </div>
          </div>
