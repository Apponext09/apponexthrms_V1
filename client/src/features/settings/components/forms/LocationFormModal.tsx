...
export function LocationFormModal({ onSubmit, onClose, editingId }: LocationFormModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-background dark:bg-gray-800 rounded-lg shadow-lg p-8 max-w-2xl w-full mx-4 my-8">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-border dark:border-gray-600 rounded-lg bg-background dark:bg-gray-700 text-foreground dark:text-white"
          ...
          <div className="flex gap-3 mt-8">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2 border border-border dark:border-gray-600 rounded-lg text-foreground dark:text-white hover:bg-muted/50 dark:hover:bg-gray-700 transition-colors"
            >
              Cancel
            </button>
            <button
