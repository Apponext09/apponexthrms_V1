  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.data?.success && res.data.data) {
        ...
        savedCompany = {
          id: String(c.company_id || c.id || `comp-${Date.now()}`),
          code: c.code,
          name: c.name,
          employerName: c.employer_name || formEmployerName,
          classOfEstablishment: c.class_of_establishment || formClassOfEstablishment,
          addressLine1: c.address_line_1 || formAddress1,
          addressLine2: c.address_line_2 || formAddress2,
          country: c.country || formCountry,
          zipCode: c.zip_code || formZipCode,
          state: c.state || formState,
          city: c.city || formCity,
          panTin: c.pan_tin || formPanTin,
          contactNumber: c.contact_number || formContactNumber,
          email: c.email || formEmail,
          logo: c.logo || formLogo,
          companyStamp: c.company_stamp || formCompanyStamp,
          signature: c.signature || formSignature,
          isActiveToggle: c.is_active_toggle === 1 || formIsActiveToggle,
          activeUsersToggle: c.active_users_toggle === 1 || formActiveUsersToggle,
          loginPageLogoToggle: c.login_page_logo_toggle === 1 || formLoginPageLogoToggle,
