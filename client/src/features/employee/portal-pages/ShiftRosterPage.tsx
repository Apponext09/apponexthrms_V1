        ...
        <CardContent className="p-4 sm:p-5">
          {todayShift ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              ...
              <div className="relative rounded-xl overflow-hidden border border-border/70 bg-muted/20 h-40 flex flex-col justify-end p-3">
                <div className="absolute inset-0 opacity-10 bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:14px_24px]" />
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                  <div className="h-7 w-7 rounded-full bg-primary border-2 border-card flex items-center justify-center shadow-lg text-primary-foreground">
                    <MapPin className="w-3.5 h-3.5" />
                  </div>
                  <span className="text-[9px] font-bold text-primary bg-card px-2 py-0.5 rounded shadow mt-1 whitespace-nowrap border border-border/60">
                    Office Geofence
                  </span>
                </div>
                <div className="z-10 flex justify-between items-center text-[10px] text-muted-foreground font-semibold w-full">
