...
router.get('/departments', asyncHandler(async (req: Request, res: Response) => {
  ...
  // Departments are organisation-wide master data. A department may map to
  // several companies, so filtering by only its primary company hides valid
  // associations and prevents records from being fetched for editing.
